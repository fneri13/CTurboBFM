...
/** 
  *  \brief     Class handling supersonic outlet boundary condition capabilities. Every information is taken from the domain.
...
class BoundaryOutletSupersonic : public BoundaryBase {
    ...
    public:
         ...
         */
        BoundaryOutletSupersonic(const Config &config, const Mesh &mesh, FluidBase &fluid, BoundaryIndices boundIndex, std::vector<FloatType> bcValues);
            
        virtual ~BoundaryOutletSupersonic() {}
