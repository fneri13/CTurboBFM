 ...
 */
class BoundaryPeriodic : public BoundaryBase {
    ...
    public:
         ...
         */
        BoundaryPeriodic(const Config &config, const Mesh &mesh, FluidBase &fluid, BoundaryIndices boundIndex, std::vector<FloatType> inletValues);
            
        virtual ~BoundaryPeriodic() {}
