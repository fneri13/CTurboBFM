...
/** 
  ...
  */
class BoundaryWedge : public BoundaryBase {
    ...
    public:
         ...
         */
        BoundaryWedge(const Config &config, const Mesh &mesh, FluidBase &fluid, BoundaryIndices boundIndex);
            
        virtual ~BoundaryWedge() {}
