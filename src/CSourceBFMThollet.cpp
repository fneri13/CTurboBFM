...
StateVector CSourceBFMThollet::computeBodyForceSource(size_t i, size_t j, size_t k, const StateVector& primitive) {
    ...
    StateVector inviscidComponent = computeInviscidComponent(i, j, k, primitive);
    StateVector viscousComponent = computeViscousComponent(i, j, k, primitive);
    return inviscidComponent + viscousComponent;
}


StateVector CSourceBFMThollet::computeInviscidComponent(size_t i, size_t j, size_t k, const StateVector& primitive) {
...
StateVector CSourceBFMThollet::computeViscousComponent(size_t i, size_t j, size_t k, const StateVector& primitive) {
