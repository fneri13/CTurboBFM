...
void AdvectionBase::reconstructMUSCL(StateVector& Wll, StateVector& Wl, StateVector& Wr, StateVector& Wrr, FluxLimiter fluxLimiter) const {
...
StateVector AdvectionBase::computeSmoothness(const StateVector& Wl, const StateVector& Wc, const StateVector& Wr) const {
...
StateVector AdvectionBase::computeLimiter(const StateVector& smoothness, FluxLimiter fluxLimiter) const{
