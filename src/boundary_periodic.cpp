#include "boundary_periodic.hpp"
#include "math_utils.hpp"

BoundaryPeriodic::BoundaryPeriodic(const Config &config, const Mesh &mesh, FluidBase &fluid, BoundaryIndices boundIndex, std::vector<FloatType> inletValues)
...
StateVector BoundaryPeriodic::computeBoundaryFlux(StateVector internalConservative, Vector3D surface, Vector3D midPoint, std::array<size_t, 3> indices, const FlowSolution &solution, const size_t iterCounter) {
